...
function JemisseCta() {
  return (
    <div className="bg-gray-900">
      <NavbarCTA />
      <div className="relative isolate overflow-hidden bg-gradient-to-br from-sky-00 to-[#101828] px-3 py-20 sm:py-32 lg:overflow-visible lg:px-0">
        <div className="mx-auto max-w-4xl">
          {/* Card original mantido totalmente intacto */}
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-16 shadow-2xl rounded-3xl sm:px-8 md:py-20 lg:flex lg:gap-x-20 lg:px-12 border-2 border-gray-700">
            ...
            <div className="mx-auto max-w-md lg:mx-0 lg:flex-auto lg:py-12 lg:text-left space-y-6">
              ...
              <div className="space-y-2">
                <h2 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">Jemisse Macuacua.</h2>
              ...
              <p className="text-lg leading-relaxed text-gray-400 font-mono">
                Eu sou um Software Developer com mais de 1 ano de experiência em prover soluções para problemas usando
                tecnologia.
              </p>
